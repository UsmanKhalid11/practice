...
public class MyDbUserDetailService  implements UserDetailsService {
    ...
    public UserDetailEntity getAuthCredForCustomToken(String s) throws UsernameNotFoundException {
        Optional<UserDetailEntity> userDetailsOptional = userDetailRepo.findByUsername(s);
        UserDetailEntity userDetailsEntity = userDetailsOptional.orElseThrow(
